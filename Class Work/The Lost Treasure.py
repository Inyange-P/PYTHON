...
print("You find yourself in a mysterious game. There are other questions I would Like to Ask you.")
...
print("Congratulations! You have completed the Lost Treasure Game!")
print("Welcome to the bonus challenge!")

#Unlock Legendary Treasure
